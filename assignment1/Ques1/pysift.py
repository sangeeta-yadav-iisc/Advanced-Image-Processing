from numpy import sin, exp, dot, log, logical_and, roll, sqrt, stack, trace, unravel_index 
from numpy import all, any, array, arctan2, cos
from numpy import pi, deg2rad, rad2deg, where, zeros, floor, full, nan, isnan, round, float32
from numpy.linalg import lstsq, norm, det 
from cv2 import INTER_LINEAR, INTER_NEAREST, resize, GaussianBlur, subtract, KeyPoint
...
def generateGaussianKernels(sigma, num_intervals):
    """Generate list of gaussian kernels at which to blur the input image. Default values of sigma, intervals"""
